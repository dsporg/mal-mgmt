...
custom_replacements = {
  ...
  */
  names = {
    ...
    defender_email_security_contact = "david.stewart-palapanou@outlook.com"
    ...
    # Resource names
    log_analytics_workspace_name            = "log-management-$${starter_location_01}"
    ...
    primary_hub_name                                   = "vhub-hub-$${starter_location_01}"
    primary_sidecar_virtual_network_name               = "vnet-sidecar-$${starter_location_01}"
    primary_firewall_name                              = "afw-hub-$${starter_location_01}"
    primary_firewall_policy_name                       = "afwp-hub-$${starter_location_01}"
    ...
    primary_private_dns_resolver_name                  = "dnspr-hub-dns-$${starter_location_01}"
    primary_bastion_host_name                          = "bas-hub-$${starter_location_01}"
    primary_bastion_host_public_ip_name                = "pip-bas-hub-$${starter_location_01}"

    # Resource names secondary connectivity
    secondary_hub_name                                   = "vhub-hub-$${starter_location_02}"
    secondary_sidecar_virtual_network_name               = "vnet-sidecar-$${starter_location_02}"
    secondary_firewall_name                              = "afw-hub-$${starter_location_02}"
    secondary_firewall_policy_name                       = "afwp-hub-$${starter_location_02}"
    ...
    secondary_private_dns_resolver_name                  = "dnspr-hub-dns-$${starter_location_02}"
    secondary_bastion_host_name                          = "bas-hub-$${starter_location_02}"
    secondary_bastion_host_public_ip_name                = "pip-bas-hub-$${starter_location_02}"
...
management_group_settings = {
  ...
  subscription_placement = {
    identity = {
      ...
      management_group_name = "mg-mal-identity"
    }
    connectivity = {
      subscription_id       = "$${subscription_id_connectivity}"
      management_group_name = "mg-mal-connectivity"
    }
    management = {
      subscription_id       = "$${subscription_id_management}"
      management_group_name = "mg-mal-management"
    }
    security = {
      subscription_id       = "$${subscription_id_security}"
      management_group_name = "mg-mal-security"
    }
  }
    ...
    mg-mal = {
      policy_assignments = {
        Deploy-MDFC-Config-H224 = {
          parameters = { # Can be set to DeployIfNotExists or Disabled depending on your preference
